		...
		<div class="card shadow">
			<div class="card-body">
				...
				<div class="d-none d-md-block">
					...
					<c:otherwise>
						<li class="page-item">
							<a href="${root }board/main?board_info_idx=${board_info_idx }&page=${pageVO.prevPage }" class="page-link">이전</a>
						</li>
					</c:otherwise>
					</c:choose>
						...
						<c:forEach var="idx" begin="${pageVO.min }" end="${pageVO.max }">
							<c:choose>
								<c:when test="${idx == pageVO.currentPage }">
									...
									<a href="${root }board/main?board_info_idx=${board_info_idx}&page=${idx}" class="page-link">${idx }</a></li>
								</c:when>
								<c:otherwise>
									<li class="page-item">
						...
						<c:choose>
							...
							<c:otherwise>
								<li class="page-item">
									<a href="${root }board/main?board_info_idx=${board_info_idx}&page=${pageVO.nextPage}" class="page-link">다음</a>
							</c:otherwise>
						</c:choose>
					</ul>
				</div>
				...
				<div class="d-block d-md-none">
					<ul class="pagination justify-content-center">
						<li class="page-item">
						<a href="${root }board/main?board_info_idx=${board_info_idx}&page=${pageVO.prevPage}" class="page-link">이전</a></li>
						<li class="page-item">
						<a href="${root }board/main?board_info_idx=${board_info_idx}&page=${pageVO.nextPage}" class="page-link">다음</a></li>
					</ul>
				</div>
